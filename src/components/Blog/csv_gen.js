        ...
        <body>
            ...
            <div className="blog container">
                ...
                <div className="body_text">
                    ...
                    <a href="https://github.com/JpBongiovanni/WorldDeityDatabase/blob/main/wiki_app/views.py">GitHub</a>
                    ...
                    <p className="tab">
                        The function in views.py returns an HttpResponse that takes the content type of "text/csv." Because every column in my database is not really necessary to export (like contributor id, or upload date), the function writes rows based on the selected columns, skipping over the ones not selected. 
                    </p>
                </div>
            </div>
            <NavBar></NavBar>
